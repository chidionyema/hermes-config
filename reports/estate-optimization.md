...
**Generated:** 2026-08-15 06:58:09
**Sources:** 5 bottleneck reports, 1 near-miss, 1 trends, 20 alerts, 10 policies

## 🟠 High Priority
- **Alert type 'CRON_SILENT_STRETCH' fired 8 times**
  → Recurring issue — needs root cause fix, not symptom handling
- **Alert type 'WAKE_GRACE' fired 6 times**
  → Recurring issue — needs root cause fix, not symptom handling
- **Alert type 'CRON_ERROR' fired 6 times**
  → Recurring issue — needs root cause fix, not symptom handling

## 🟡 Medium Priority
- **140 policies have never triggered**
...
- **Recurring pattern: Policy pol-20260618-008 appears untriggered in 556 consecutive near-miss scans**
...
- **Recurring pattern: Policy pol-20260618-004 appears untriggered in 283 consecutive near-miss scans**
  → Occurred ? times — consider automating this
- **Recurring pattern: Policy pol-auto-fix-config_push appears untriggered in 263 consecutive near-miss**
  → Occurred ? times — consider automating this
...
- [x] `fix_recurring_wake_grace` — highest priority: high
