...
## 🟡 Medium Priority
- **55 policies have never triggered**
...
- **Recurring pattern: Policy pol-20260618-008 appears untriggered in 606 consecutive near-miss scans**
  → Occurred ? times — consider automating this
- **Recurring pattern: Policy pol-auto-fix-config_push appears untriggered in 313 consecutive near-miss**
  → Occurred ? times — consider automating this
