...
## 🟡 Medium Priority
- **25 policies have never triggered**
  → Consider archiving or rewriting: pol-20260618-008, pol-auto-fix-config_push, pol-shadow-gap-20260815-070052-automation, pol-shadow-gap-20260815-080000-api_usage, pol-shadow-gap-20260815-080000-automation
...
- **Recurring pattern: Policy pol-20260618-008 appears untriggered in 572 consecutive near-miss scans**
...
- **Recurring pattern: Policy pol-20260618-004 appears untriggered in 283 consecutive near-miss scans**
  → Occurred ? times — consider automating this
- **Recurring pattern: Policy pol-auto-fix-config_push appears untriggered in 279 consecutive near-miss**
  → Occurred ? times — consider automating this
